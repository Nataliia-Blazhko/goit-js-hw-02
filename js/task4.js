...
function formatString (string, maxLength = 40) {
    ...
    // const fixedString =  string.slice(0, maxLength);
    const result = string.length >= maxLength ? string.slice(0, maxLength) + '...' : string;
    return result;
  }
  
  const result = formatString('Curabitur ligula sapien, tincidunt non.');
  console.log(result);
